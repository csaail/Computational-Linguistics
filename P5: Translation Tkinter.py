...
InputLanguageChoiceMenu =
OptionMenu(Screen,InputLanguageChoice,*LanguageChoices)
...
B = Button(Screen,text="Translate",command=Translate, relief =
GROOVE).grid(row=3,column=1,columnspan = 3)
mainloop()
